...
/** biome-ignore-all lint/a11y/useAnchorContent: it's fine */
/** biome-ignore-all lint/a11y/useValidAnchor: it's fine */
import {
	AlertTriangleIcon,
	ArchiveIcon,
	ArrowLeftIcon,
...
import { Example, ExampleWrapper } from "@/ui/components/example"
		...
		<Example title="Card" className="items-center justify-center">
			<Card className="relative w-full max-w-sm overflow-hidden pt-0">
				...
				<img
					...
					alt="Gradient by mymind on Unsplash"
