import { APP_BASE_PATH, type Collection, type Singleton, type ContentFormat, type SingletonFormat } from '@kobun/common'
...
export function createNodeCollectionManager(
	...
	return new CollectionContentManager(nodeStorage, collection, format, getPath)
}
...
export async function readItemsInLocalCollection(params: {
	...
	const manager = createNodeCollectionManager(params.collection, params.format)
